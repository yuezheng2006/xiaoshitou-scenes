...
when-to-use: |
  ...
  无角色入口：不要人物、纯物件、无 IP、none——切换 ip-profiles/none。  显式风格词：实物图、实物场景、物件小现场；手绘图、手绘解释、白板图、逻辑图；知识卡、图文号知识卡、手机海报、方法拆解图、收藏图、竖版传播图；PPT、课件、直播分享页、主题演讲、整套演讲页面、按大纲逐页出图、演讲页面、导演规划卡。默认 profile 也接受「小石头实物图 / 小石头手绘图」。
