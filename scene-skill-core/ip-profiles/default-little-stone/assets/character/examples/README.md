...
> 小石头默认**单锚点**：`../primary-character-reference.png`。  
> **双参考（对齐人）在老杨**：见 `../../persona/examples/README.md` 与 `persona-author-assets.md`。

本目录样张仅在**小石头身份明显漂移**或质量不稳时**可选**加读 1 张，不强制，不替代设定图。  
**校准图只管「在此画风里仍像小石头」，不管构图。**
...
| 3D / 渐变 / 体积漂移 | 设定图 + 上表对应模式 calibrate + `character.md` 2D Flat Lock |
...
`v1.6` · 2026-07-16 · K 歌校准务实版：禁悬浮假肢；Pose Budget（≤2 臂职 / ≤1 握持）；允许自然发挥
